...
func TestAuthenticateWithWrongPassword(t *testing.T) {
	...
	fixtures.AddUser(tdb.Store, "osagie", "desmond", false)
...
func TestAuthenticateSuccess(t *testing.T) {
	tdb := setup(t)
	defer tdb.teardown(t)
	insertedUser := fixtures.AddUser(tdb.Store, "osagie", "desmond", false)
